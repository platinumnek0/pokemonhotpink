...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_CHARMANDER - 1]    = ANIM_GROW_VIBRATE,
    ...
    [SPECIES_PIDGEY - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_PIDGEOTTO - 1]     = ANIM_V_STRETCH,
    [SPECIES_PIDGEOT - 1]       = ANIM_FRONT_FLIP,
    [SPECIES_RATTATA - 1]       = ANIM_BOUNCE_ROTATE_TO_SIDES,
    ...
    [SPECIES_CORPHISH - 1]      = ANIM_ROTATE_TO_SIDES_FAST,
    ...
    [SPECIES_YAMPER - 1]        = ANIM_GROW_VIBRATE,
