...
const u8 gText_EggNickname[] = _("Eeg");
...
const u8 gText_DexHoennTitle[] = _("Gagil Dex");
const u8 gText_DexNatTitle[] = _("NATIONAL DEX");
const u8 gText_DexSortNumericalTitle[] = _("Numerically");
const u8 gText_DexSortAtoZTitle[] = _("Alphabetically");
const u8 gText_DexSortHeaviestTitle[] = _("Heaviest first");
const u8 gText_DexSortLightestTitle[] = _("Lightest first");
const u8 gText_DexSortTallestTitle[] = _("Largest first");
const u8 gText_DexSortSmallestTitle[] = _("Smallest first");
...
const u8 gText_DexSearchColorGray[] = _("Grey");
const u8 gText_DexSearchColorWhite[] = _("White");
const u8 gText_DexSearchColorPink[] = _("Pink");
const u8 gText_DexHoennDescription[] = _("Gagil region Pokédex");
const u8 gText_DexNatDescription[] = _("National edition POKéDEX");
const u8 gText_DexSortNumericalDescription[] = _("Pokédex are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned Pokédex are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned Pokédex are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned Pokédex are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned Pokédex are listed from the\nlargest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned Pokédex are listed from the\nsmallest to the largest.");
...
const u8 gText_EggCantBattle[] = _("An Eeg can't battle!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AlreadySurfing[] = _("You're already Surfing, idiot.");
...
const u8 gText_NextLv[] = _("To Next Lvl");
...
const u8 gText_PkmnSkills[] = _("Pokémon Stats");
const u8 gText_BattleMoves[] = _("Known Moves");
const u8 gText_ContestMoves[] = _("C0NTEST MOVES");
const u8 gText_Info[] = _("Info");
const u8 gText_EggWillTakeALongTime[] = _("It looks like this Eeg will\ntake a long time to hatch.");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd Pokémon Eeg found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar Pokémon Eeg\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar Pokémon Eeg\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A Pokémon Eeg obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd Pokémon Eeg\nobtained from a traveler.");
