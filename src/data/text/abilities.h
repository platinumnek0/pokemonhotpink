...
static const u8 sFlytrapDescription[]= _("Bug moves heal HP.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_HUSTLE] = _("Grindset"),
    [ABILITY_CUTE_CHARM] = _("Mad Love Body"),
    [ABILITY_PLUS] = _("Plus"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_FLYTRAP] = sFlytrapDescription,
};
