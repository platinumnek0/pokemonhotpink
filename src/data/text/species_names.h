    ...
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_BULBASAUR] = _("Croconut"),
    [SPECIES_IVYSAUR] = _("Tropidile"),
    [SPECIES_VENUSAUR] = _("Oiligator"),
    [SPECIES_CHARMANDER] = _("Skrappup"),
    [SPECIES_CHARMELEON] = _("Hotweiler"),
    [SPECIES_CHARIZARD] = _("Cerberawl"),
    [SPECIES_SQUIRTLE] = _("Kitfisk"),
    [SPECIES_WARTORTLE] = _("Shokkat"),
    [SPECIES_BLASTOISE] = _("Panthunder"),
    ...
    [SPECIES_PIDGEY] = _("Eggrole"),
    [SPECIES_PIDGEOTTO] = _("Actern"),
    [SPECIES_PIDGEOT] = _("Theatrice"),
    [SPECIES_RATTATA] = _("Sqweekling"),
    [SPECIES_RATICATE] = _("Clamorat"),
    ...
    [SPECIES_CLEFAIRY] = _("Cakelstack"),
    [SPECIES_CLEFABLE] = _("Gingenacl"),
    ...
    [SPECIES_PONYTA] = _("Coofoal"),
    [SPECIES_RAPIDASH] = _("Equavian"),
    ...
    [SPECIES_KRABBY] = _("Bumblin"),
    [SPECIES_KINGLER] = _("Bumblkrust"),
    ...
    [SPECIES_HITMONLEE] = _("Pigot"),
    [SPECIES_HITMONCHAN] = _("Hogest"),
    ...
    [SPECIES_GOLDEEN] = _("Piscolo"),
    [SPECIES_SEAKING] = _("Pischool"),
    ...
    [SPECIES_SENTRET] = _("Roderect"),
    [SPECIES_FURRET] = _("Chodent"),
    [SPECIES_HOOTHOOT] = _("Hoothoot"),
    [SPECIES_NOCTOWL] = _("Noctowl"),
    [SPECIES_LEDYBA] = _("Katred"),
    [SPECIES_LEDIAN] = _("Katriol"),
    [SPECIES_SPINARAK] = _("Spidirt"),
    [SPECIES_ARIADOS] = _("Marrantula"),
    [SPECIES_CROBAT] = _("Crobat"),
    [SPECIES_CHINCHOU] = _("Chinchou"),
    [SPECIES_LANTURN] = _("Lanturn"),
    [SPECIES_PICHU] = _("Pichu"),
    [SPECIES_CLEFFA] = _("Cookli"),
    ...
    [SPECIES_TYROGUE] = _("Porkid"),
    [SPECIES_HITMONTOP] = _("Hamfiston"),
    ...
    [SPECIES_MIGHTYENA] = _("Apathound"),
    [SPECIES_ZIGZAGOON] = _("Zigzagoon"),
    [SPECIES_LINOONE] = _("Linoone"),
    [SPECIES_WURMPLE] = _("Inchwyrm"),
    [SPECIES_SILCOON] = _("Drakoon"),
    [SPECIES_BEAUTIFLY] = _("Flutterror"),
    [SPECIES_CASCOON] = _("Cascoon"),
    [SPECIES_DUSTOX] = _("Dustox"),
    [SPECIES_LOTAD] = _("Creepeat"),
    [SPECIES_LOMBRE] = _("Swampeat"),
    [SPECIES_LUDICOLO] = _("Ludicolo"),
    [SPECIES_SEEDOT] = _("Bencha"),
    [SPECIES_NUZLEAF] = _("Benchapero"),
    [SPECIES_SHIFTRY] = _("Abingranil"),
    ...
    [SPECIES_CORPHISH] = _("Icopod"),
    [SPECIES_CRAWDAUNT] = _("Icerrate"),
    ...
    [SPECIES_LILLIPUP] = _("Borzy"),
    [SPECIES_HERDIER] = _("Borzyzy"),
    [SPECIES_STOUTLAND] = _("Borzyzyzy"),
    ...
    [SPECIES_VENIPEDE] = _("Azzalien"),
    [SPECIES_WHIRLIPEDE] = _("Weevillain"),
    [SPECIES_SCOLIPEDE] = _("Weevicious"),
    ...
    [SPECIES_SANDILE] = _("Croconut"),
    [SPECIES_KROKOROK] = _("Tropidile"),
    [SPECIES_KROOKODILE] = _("Oiligator"),
    [SPECIES_DARUMAKA] = _("Salivolt"),
    [SPECIES_DARMANITAN] = _("Mastidic"),
    ...
    [SPECIES_FOONGUS] = _("Skungus"),
    [SPECIES_AMOONGUSS] = _("Skungrowth"),
    ...
    [SPECIES_KLINK] = _("Willywoo"),
    [SPECIES_KLANG] = _("Wirlydoo"),
    ...
    [SPECIES_FENNEKIN] = _("Skrappup"),
    [SPECIES_BRAIXEN] = _("Hotweiler"),
    [SPECIES_DELPHOX] = _("Cerberawl"),
    ...
    [SPECIES_LITTEN] = _("Kitfisk"),
    [SPECIES_TORRACAT] = _("Ampurr"),
    [SPECIES_INCINEROAR] = _("Panthunder"),
    ...
    [SPECIES_CHEWTLE] = _("Shellite"),
    [SPECIES_DREDNAW] = _("Shellossal"),
    [SPECIES_YAMPER] = _("Caonine"),
    [SPECIES_BOLTUND] = _("Lupensa"),
    ...
    [SPECIES_SNOM] = _("Snaam"),
    [SPECIES_FROSMOTH] = _("Fraamoth"),
...
//Hisuian Forms
    ...
    // Flabébé
    [SPECIES_FLABEBE_YELLOW_FLOWER] = _("Baloom"),
    [SPECIES_FLABEBE_ORANGE_FLOWER] = _("Baloom"),
    [SPECIES_FLABEBE_BLUE_FLOWER] = _("Baloom"),
    [SPECIES_FLABEBE_WHITE_FLOWER] = _("Baloom"),
    // Floette
    [SPECIES_FLOETTE_YELLOW_FLOWER] = _("Coulrimar"),
    [SPECIES_FLOETTE_ORANGE_FLOWER] = _("Coulrimar"),
    [SPECIES_FLOETTE_BLUE_FLOWER] = _("Coulrimar"),
    [SPECIES_FLOETTE_WHITE_FLOWER] = _("Coulrimar"),
