static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_MAYS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_MAYS_HOUSE_2F), 1, 8},
    ...
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(FIRST_GYM_TOWN), MAP_NUM(FIRST_GYM_TOWN), 40, 32},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 7, 11},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 26, 16},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 16, 15},
    ...
    [HEAL_LOCATION_BUG_FOREST - 1] = {MAP_GROUP(BUG_FOREST), MAP_NUM(BUG_FOREST), 44, 52},
    [HEAL_LOCATION_FIRST_GYM_TOWN - 1] = {MAP_GROUP(FIRST_GYM_TOWN), MAP_NUM(FIRST_GYM_TOWN), 40, 32},
};
