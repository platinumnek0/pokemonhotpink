...
const u32 gTrainerFrontPic_Salesman[] = INCBIN_U32("graphics/trainers/front_pics/salesman.4bpp.lz");
const u32 gTrainerPalette_Salesman[] = INCBIN_U32("graphics/trainers/front_pics/salesman.gbapal.lz");