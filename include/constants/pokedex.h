...
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_BULBASAUR, //croconut
    HOENN_DEX_IVYSAUR, //tropidile
    HOENN_DEX_VENUSAUR, //oiligator
    HOENN_DEX_CHARMANDER, //skrappup
    HOENN_DEX_CHARMELEON, //hotweiler
    HOENN_DEX_CHARIZARD, //cerberawl
    HOENN_DEX_SQUIRTLE, //kitfisk
    HOENN_DEX_WARTORTLE, //ampurr
    HOENN_DEX_BLASTOISE, //panthunder
    HOENN_DEX_SENTRET, //roderect 
    HOENN_DEX_FURRET, //chodent
    HOENN_DEX_PIDGEY, //eggrole
    HOENN_DEX_PIDGEOTTO, //actern
    HOENN_DEX_PIDGEOT, //theatrice
    HOENN_DEX_RATTATA, //sqweekling
    HOENN_DEX_RATICATE, //clamorat
    HOENN_DEX_VENIPEDE, //azzalien
    HOENN_DEX_WHIRLIPEDE, //weevillain
    HOENN_DEX_SCOLIPEDE, //weevicious
    HOENN_DEX_SPINARAK, //spidirt
    HOENN_DEX_ARIADOS, //marrantula
    HOENN_DEX_YAMPER, //caonine
    HOENN_DEX_BOLTUND, //lupensa
    HOENN_DEX_MIGHTYENA, //apathound
    HOENN_DEX_PACHIRISU, //maya pikaclone
    HOENN_DEX_TYROGUE, //porkid
    HOENN_DEX_HITMONCHAN, //pigot
    HOENN_DEX_HITMONLEE, //hogest
    HOENN_DEX_HITMONTOP, //hamfiston
    HOENN_DEX_SNOM, //snaam
    HOENN_DEX_FROSMOTH, //frosmoth
    HOENN_DEX_SEEDOT, //bencha
    HOENN_DEX_NUZLEAF, //benchappearo
    HOENN_DEX_SHIFTRY, //abgingrainl
    ...
    HOENN_DEX_LOTAD, //creepeat
    HOENN_DEX_LOMBRE, //swampeat
    HOENN_DEX_CHEWTLE, //shellure
    HOENN_DEX_DREDNAW, //shellossal
    HOENN_DEX_DARUMAKA, //salivolt
    HOENN_DEX_DARMANITAN, //mastidic
    HOENN_DEX_LILLIPUP, //borzy
    HOENN_DEX_HERDIER, //borzyzy
    HOENN_DEX_STOUTLAND, //borzyzyzy
    ...
    HOENN_DEX_CLEFFA, //cookli
    HOENN_DEX_CLEFAIRY, //cakelstack
    HOENN_DEX_CLEFABLE, //gingenacl
    HOENN_DEX_SHELMET, //bunbble
    HOENN_DEX_SHELLOS, //usluggi
    HOENN_DEX_GASTRODON, //gastrabbod
    HOENN_DEX_SALANDIT, //sigmander
    HOENN_DEX_CHIKORITA, //tadrose
    HOENN_DEX_BAYLEEF, //ravenus
    HOENN_DEX_MEGANIUM, //gluttoad
    HOENN_DEX_CYNDAQUIL, //cyndaquil
    HOENN_DEX_QUILAVA, //crustemper
    HOENN_DEX_TYPHLOSION, //carcinerate
    HOENN_DEX_SLAKOTH, //capybud
    HOENN_DEX_VIGOROTH, //capybrah
    HOENN_DEX_SLAKING, //capyberic
    HOENN_DEX_KRABBY, //bumblin
    HOENN_DEX_KINGLER, //bumblecrust
    HOENN_DEX_CARBINK, //cixno
    HOENN_DEX_MURKROW, //magpile
    HOENN_DEX_HONCHKROW, //ravennui
    HOENN_DEX_EKANS, //pareccur
    HOENN_DEX_ARBOK, //parereccur
    ...
    HOENN_DEX_MANKEY, //monkraft
    HOENN_DEX_PRIMEAPE, //monqi
    HOENN_DEX_ROGGENROLA, //bakrete
    HOENN_DEX_BOLDORE, //pastrified
    HOENN_DEX_GIGALITH, //cheftonic
    HOENN_DEX_SPHEAL, //smallcryo
    HOENN_DEX_SEALEO, //glashalmon
    HOENN_DEX_WALREIN, //cryozuna
    HOENN_DEX_MIMIKYU, //gottuga
    HOENN_DEX_UNOWN, //purazi
    HOENN_DEX_MARILL, //aburilado
    HOENN_DEX_PETILIL, //takeyano
    HOENN_DEX_LILLIGANT, //takeyuki
    HOENN_DEX_VULPIX, //ignizard
    HOENN_DEX_NINETALES, //demolizard
    HOENN_DEX_JOLTEON, //volteon
    HOENN_DEX_SABLEYE, //koboleye
    HOENN_DEX_GEODUDE, //rotrock
    HOENN_DEX_GRAVELER, //shamboulder
    HOENN_DEX_GOLEM, //rottyrant
    HOENN_DEX_FARFETCHD, //peeplumb
    HOENN_DEX_FLETCHLING, //chilichick
    HOENN_DEX_FLETCHINDER, //hensear
    HOENN_DEX_SNORUNT, //snimp
    HOENN_DEX_GLALIE, //sneezon
    HOENN_DEX_FROSLASS, //smellevel
    HOENN_DEX_DONPHAN, //bowlder
    HOENN_DEX_DEOXYS,
};
